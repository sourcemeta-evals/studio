    ...
    <div className="flex flex-col h-screen p-5">
      ...
      <div className="flex-1 overflow-y-auto">
        {state.isLoading ? (
          ...
          <>
                        {activeTab === 'lint' && <LintTab lintResult={state.lintResult} blocked={state.blockedByMetaschema ?? false} noFileSelected={state.noFileSelected ?? false} />}
                        {activeTab === 'format' && <FormatTab formatResult={state.formatResult} fileInfo={state.fileInfo} hasParseErrors={state.hasParseErrors ?? false} blocked={state.blockedByMetaschema ?? false} noFileSelected={state.noFileSelected ?? false} />}
