...
globalThis.window = { acquireVsCodeApi: mockAcquireVsCodeApi } as unknown as Window & typeof globalThis;
...
describe('VSCodeAPIWrapper', () => {
  ...
  describe('openExternal', () => {
    ...
    it('should post a single message per call', () => {
      vscode.openExternal('https://example.com');
